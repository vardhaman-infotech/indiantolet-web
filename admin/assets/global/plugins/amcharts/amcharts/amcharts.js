...
AmCharts.SimpleChartScrollbar = AmCharts.Class({
    ...
    draw: function() {
        ...
        if ((a.height = g) && f) {
            ...
            f = d.pathToImages;
            c ? (h = "images/dragIconH.gif", f = a.dragIconWidth, c = a.dragIconHeight) : (h = "http://192.168.2.145/food_delivery/admin/assets/global/plugins/amcharts/amcharts/images/dragIcon.gif",
