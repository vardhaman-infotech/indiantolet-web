...
//                }
    ...
    //This function add by shyam for sent box
    var loadSentbox = function (el, name) {
        var url = 'sentbox.php';
        var title = $('.inbox-nav > li.' + name + ' a').attr('data-title');
        listListing = name;
    ...
    //This function add by shyam for Draft
    var loadDraftMessage = function (el, name) {
        var url = 'draft.php';
        var title = $('.inbox-nav > li.' + name + ' a').attr('data-title');
        listListing = name;
...
//                }
    ...
    //This function add by shyam for trash
    var loadTrashMessage = function (el, name) {
        var url = 'trash.php';
        var title = $('.inbox-nav > li.' + name + ' a').attr('data-title');
        listListing = name;
...
var loadReplyForward = function (el) {
        var messageid = $(el).attr("data-messageid");
        var url = 'inbox_Forward.php?messageid=' + messageid;
    ...
    return {
        ...
        init: function () {
            ...
            $('.inbox-nav > li.sent > a').click(function () {
                loadSentbox($(this), 'sent');
            });

            // handle draft listing
            $('.inbox-nav > li.draft > a').click(function () {
                loadDraftMessage($(this), 'draft');
            });

            // handle trash listing
            $('.inbox-nav > li.trash > a').click(function () {
                loadTrashMessage($(this), 'trash');
            });
            ...
            //handle compose/forword bcc input toggle
