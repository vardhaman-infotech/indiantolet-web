                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green-sharp bold uppercase">Owner</span>
                                <span class="caption-helper">manage owner...</span>
                            </div>
                            <div class="actions">
                                <a href="<?= $_SERVER['PHP_SELF'] ?>?action=addOwner" class="btn btn-default btn-circle">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                    <thead>
                                        ...
                                        <tr role="row" class="filter noExl">
                                            ...
                                            <td>
                                                <input type="text" class="form-control form-filter input-sm" name="owner_otp">
                                            </td>
...
<script>
       jQuery(document).ready(function() {
        ...
        var handleRecords = function() {
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                    ...
                    "ajax": {
                        "url": "<?php echo ADMIN_URL; ?>/modules/owner/ajax/table_ajax.php"// ajax source
                    },                                
                    "order": [
                        [1, "desc"]
        ...
        $('body').delegate('.btn-danger', 'click', function(evt) {
            ...
            bootbox.confirm('<?php echo OWNER_CONFIRM_DELETE; ?>', function(result) {
                console.log(result);
                if (result) {                    
