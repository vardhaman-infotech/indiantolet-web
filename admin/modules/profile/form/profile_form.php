                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tab_1_2">
                                                ...
                                                <form id="setting_form" name="setting_form" accept-charset="utf-8" method="post" action="<?= $_SERVER['PHP_SELF']; ?>">
                                                    <div class="form-group">
                                                        <label class="control-label">Owner Charge</label>
                                                        <input type="text" class="fild form-control validate[required,custom[number]]"   name="owner_charge" id="owner_charge" value="<?= $admin_data->owner_charge; ?>"/>
                                                    </div>                                                        
                                                    <div class="form-group">
                                                        <label class="control-label">Tenant Charge</label>
                                                        <input type="text" class="fild form-control validate[required,custom[number]]"   name="tenant_charge" id="tenant_charge" value="<?= $admin_data->tenant_charge; ?>"/>
                                                    </div>                                                        
                                                    <div class="form-group">
