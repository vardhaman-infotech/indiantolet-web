                                                    ...
                                                    <div class="portlet grey-cararra box">
                                                        ...
                                                        <div class="portlet-body">
                                                            <ul class="list-inline">
                                                                ...
                                                                <li>
                                                                    <i class="fa fa-home"></i> <?php echo valueNamePrimary('property_typeModel', $property_type_id, 'name'); ?>
                                                                </li>
                                                                <li>
                                                                    <i class="fa fa-square"></i> <?php echo (isset($property_area) ? $property_area : ""); ?>
                                                                </li>
                                                            ...
                                                            <div class="row static-info">
                                                                ...
                                                                <div class="col-md-7 value">
                                                                    <?php echo valueNamePrimary('property_typeModel', $property_type_id, 'name').' '.(isset($floor) ? $floor : "").' '.(isset($no_of_room) ? $no_of_room : ""); ?>
                                                                </div>
                                                            </div>
                                                            <!--                                                            <div class="row static-info">
                                                                                                                            <div class="col-md-5 name">
