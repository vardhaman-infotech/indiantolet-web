        ...
        <div class="page-head">
            <div class="container">
                ...
                <div class="page-title">
                    <h1> User <?php echo (isset($action) && $action == "editUser") ? "Edit" : "Add" ?> <small>create & edit user</small></h1>
                    ...
                    <div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_0">
                                <form class='form-horizontal' name='userForm' id='userForm' method='post' action='' enctype='multipart/form-data'>
                                    <div class="portlet light">                                        
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="icon-user font-green-sharp"></i>
                                                <span class="caption-subject font-green-sharp bold uppercase">
                                                    <?php echo (isset($action) && $action == "editUser") ? "Edit" : "Add" ?> User </span>
                                            ...
                                            <div class="actions btn-set">
                                                ...
                                                <input type="submit" name="submitUser" class="btn green-haze btn-circle" value="Save">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <textarea type="text" rows="3" placeholder="Enter Address" class="form-control validate[required]" name="address" id="address"><?php echo (isset($address) ? $address : "") ?></textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    if ($action == 'editUser') {
                                                        if (isset($image) && !empty($image)) {
                                                            ...
                                                            <div class="col-md-5">
                                                                ...
                                                                <img height="100px" width="100px" src="<?php echo UPLOAD_URL; ?>/user_image/<?php echo $image; ?>">
                                                            </div>
                                                            <?php
                                                        }
                                                    ...
                                                    <?php
                                                        ...
                                                        if (isset($adhar_card) && !empty($adhar_card)) {
                                                            ?>
                                                            <div class="col-md-5">
                                                                <!--                                                        <label class="control-label">Image</label>-->
                                                                <img height="100px" width="100px" src="<?php echo UPLOAD_URL; ?>/user_adhar_card/<?php echo $adhar_card; ?>">
                                                            </div>
                                                            <?php
                                                        }
                                                    }
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        ...
                                                        <input type="submit" class="btn btn-primary green" value="Save" name="submitUser" id="submitUser">
...
<script type='text/javascript'>
    ...
    jQuery(document).ready(function ($) {
        $('#email_id, input[type="reset"]').bind("keyup click change", function () {
            ...
            $.post("<?php echo ADMIN_URL ?>/modules/users/ajax/ajax_email.php",
                    {
                        email: email,
                        Email: Email
                    }, function (data) {
    ...
    jQuery(document).ready(function ($) {
        $('#phone_number, input[type="reset"]').bind("keyup click change", function () {
            ...
            $.post("<?php echo ADMIN_URL ?>/modules/users/ajax/ajax_phone_no.php",
                    {
                        mobile: mobile,
                        Mobile: Mobile
                    }, function (data) {
