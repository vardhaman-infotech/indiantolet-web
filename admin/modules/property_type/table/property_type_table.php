                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green-sharp bold uppercase">property type</span>
                                <span class="caption-helper">manage property type...</span>
                            </div>
                            <div class="actions">
                                <a href="<?= $_SERVER['PHP_SELF'] ?>?action=addProperty_type" class="btn btn-default btn-circle">
        ...
        var handleRecords = function() {
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                    ...
                    "ajax": {
                        "url": "<?php echo ADMIN_URL; ?>/modules/property_type/ajax/table_ajax.php"// ajax source
                    },                                
                    "order": [
                        [1, "desc"]
